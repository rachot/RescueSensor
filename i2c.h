...
void ConfigIntI2C(unsigned int); 
...
unsigned int SlavegetsI2C(unsigned char *, unsigned int);
...
void OpenI2C(unsigned int,unsigned int); 

unsigned int MasterputsI2C(unsigned char *); 

unsigned int SlaveputsI2C(unsigned char *); 
...
void SlaveWriteI2C(unsigned char); 

char MasterWriteI2C(unsigned char); 
